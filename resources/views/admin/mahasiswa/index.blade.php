    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-button">
                ...
                <a href="{{ url('admin/mahasiswa/ubah_tingkat') }}" class="btn btn-secondary">Ubah Semester</a>
            </div>
        </div>
                                        ...
                                        @foreach ($users as $key => $user)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <form action="{{ url('admin/mahasiswa/' . $user->id) }}"
                                                        method="POST" id="del-{{ $user->id }}">
                                                        @csrf
                                                        @method('delete')
                                                        <a href="{{ url('admin/mahasiswa/' . $user->id) }}"
                                                            class="btn btn-info">
                                                        ...
                                                        <button type="submit" class="btn btn-danger"
                                                            data-confirm="Hapus Data?|Yakin menghapus mahasiswa <b>{{ $user->nama }}</b>?"
