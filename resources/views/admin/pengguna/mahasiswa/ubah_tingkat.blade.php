            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ url('admin/pengguna/mahasiswa/ubah_tingkat') }}" method="GET"
                                id="form-prodi">
                ...
                <div class="col-md-8">
                    <form action="{{ url('admin/pengguna/mahasiswa/ubah_tingkat_proses') }}" method="POST"
                        id="form-ubah-tingkat">
                        @csrf
                        <div class="card">
                            <div class="card-header">
