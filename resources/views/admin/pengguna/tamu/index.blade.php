    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-button">
                <a href="{{ url('admin/pengguna/tamu/create') }}" class="btn btn-primary">Tambah</a>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body p-0">
                            <div class="px-4 py-3">
                                <form action="{{ url('admin/pengguna/tamu') }}" method="GET" id="get-filter">
                                        ...
                                        @forelse ($tamus as $key => $tamu)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <form action="{{ url('admin/pengguna/tamu/' . $tamu->id) }}"
                                                        method="POST" id="del-{{ $tamu->id }}">
                                                        @csrf
                                                        @method('delete')
                                                        <a href="{{ url('admin/pengguna/tamu/' . $tamu->id) }}"
                                                            class="btn btn-info">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                        <a href="{{ url('admin/pengguna/tamu/' . $tamu->id . '/edit') }}"
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="modalImport">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ url('admin/pengguna/tamu/import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
