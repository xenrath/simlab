...
<section class="section">
  ...
  <div class="section-body">
    <div class="card">
      ...
      <form action="{{ url('admin/bahan/' . $bahan->id) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card-body">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" name="nama" id="nama" class="form-control" value="{{ old('nama', $bahan->nama) }}">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select name="ruang_id" id="ruang_id" class="form-control select2">
                  ...
                  <option value="{{ $ruang->id }}" {{ old('ruang_id', $bahan->ruang_id)==$ruang->id ? 'selected' : null
                    }}>{{ $ruang->nama
                    }}</option>
                  @endforeach
                </select>
