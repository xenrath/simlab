    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="card rounded-0 mb-3">
                ...
                <form action="{{ url('admin/tamu/' . $tamu->id) }}" method="POST" autocomplete="off" id="form-submit">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="tel" class="form-control rounded-0 @error('telp') is-invalid @enderror"
                                name="telp" id="telp" value="{{ old('telp', $tamu->telp) }}"
                        ...
                        <div class="form-group mb-2">
                            ...
                            <textarea name="alamat" id="alamat" cols="30" rows="10" class="form-control rounded-0"
                                style="height: 80px">{{ old('alamat', $tamu->alamat) }}</textarea>
                        </div>
                    </div>
                    <div class="card-footer bg-whitesmoke text-right">
                        <button type="button" class="btn btn-primary rounded-0" id="btn-submit" onclick="form_submit()">
                            ...
                            <span id="btn-submit-text">Edit Tamu</span>
                        </button>
                    </div>
                </form>
            </div>
