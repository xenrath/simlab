                                ...
                                <select class="custom-select custom-select-sm rounded-0" name="prodi"
                                    ...
                                    @foreach ($prodis as $prodi)
                                        <option value="{{ $prodi->nama }}"
                                            {{ Request::get('prodi') == $prodi->nama ? 'selected' : '' }}>
                                            {{ $prodi->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="modal-tambah">
        <div class="modal-dialog" role="document">
            <div class="modal-content rounded-0">
                ...
                <form action="{{ url('admin/bahan-pemasukan/create') }}" method="GET" id="form-tambah">
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="modal-hapus-{{ $rekap_bahan->id }}">
            <div class="modal-dialog" role="document">
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-footer bg-whitesmoke justify-content-between">
                        <button type="button" class="btn btn-secondary rounded-0" data-dismiss="modal">Batal</button>
                        <form action="{{ url('admin/bahan-pemasukan/' . $rekap_bahan->id) }}" method="POST"
