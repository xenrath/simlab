    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="card rounded-0 mb-3">
                ...
                <form action="{{ url('admin/barang') }}" method="POST" autocomplete="off" id="form-submit">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="number" name="normal" id="normal"
                                class="form-control rounded-0 @error('normal') is-invalid @enderror"
                                value="{{ old('normal') }}">
                            @error('normal')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="form-group mb-2">
                            ...
                            <textarea name="keterangan" id="keterangan" cols="30" rows="10" class="form-control rounded-0"
                                style="height: 80px">{{ old('keterangan') }}</textarea>
                        </div>
                    </div>
