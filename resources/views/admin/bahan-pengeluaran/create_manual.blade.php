    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="{{ url('admin/bahan-pengeluaran') }}" class="btn btn-secondary rounded-0">
        ...
        <div class="section-body">
            <form action="{{ url('admin/bahan-pengeluaran/manual') }}" method="POST" autocomplete="off" id="form-submit">
                @csrf
            ...
            <div class="modal-content rounded-0">
                ...
                <div class="modal-header py-3 border-bottom shadow-sm flex-column align-items-stretch">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <select class="custom-select custom-select-sm rounded-0" id="bahan-prodi-id" style="width: 160px;"
                            onchange="bahan_cari()">
...
@section('script')
    <script>
        ...
        function bahan_cari() {
            ...
            let bahan_ruang_id = $('#bahan-prodi-id').val();
