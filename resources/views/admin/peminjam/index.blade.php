            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                ...
                                <a href="{{ asset('storage/uploads/file/format_import_peminjam.xlsx') }}"
                  ...
                  document.getElementById('get-filter').submit();">
                                            <option value=""
                                                {{ Request::get('subprodi_id') == '' ? 'selected' : null }}>Semua Prodi
                                            </option>
                                        ...
                                        @forelse($users as $key => $user)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <form action="{{ url('admin/peminjam/' . $user->id) }}" method="POST"
                                                        id="del-{{ $user->id }}">
                                                        @csrf
                                                        @method('delete')
                                                        <a href="{{ url('admin/peminjam/' . $user->id) }}"
                                                            class="btn btn-info">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                        <a href="{{ url('admin/peminjam/' . $user->id . '/edit') }}"
