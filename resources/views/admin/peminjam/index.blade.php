        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="card-header-action">
              ...
              <a href="{{ asset('storage/uploads/file/format_import_peminjam.xlsx') }}" class="btn btn-success">
              ...
              <form action="{{ url('admin/peminjam') }}" method="GET" id="get-filter">
                <div class="float-left mb-3 mr-3" style="width: 180px">
                  ...
                  document.getElementById('get-filter').submit();">
                    ...
                    <option value="{{ $subprodi->id }}" {{ Request::get('subprodi_id')==$subprodi->id ? 'selected' :
                      null
