        ...
        <div class="row">
          <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 col-12">
            <table class="table">
              ...
              <tr>
                ...
                <td>:</td>
                <td>
                  @if ($barang->tempat == 'lab')
                  Lab. Terpadu
                  @elseif($barang->tempat == 'farmasi')
                  Gedung Farmasi
                  @endif
                </td>
              </tr>
              <tr>
                <th>Stok</th>
                <td>:</td>
                <td>{{ $barang->stok }} {{ $barang->satuan->nama }}</td>
              </tr>
            </table>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-8 col-8">
            <div class="chocolat-parent">
              ...
              <a href="{{ asset('storage/uploads/' . $barang->gambar) }}" class="chocolat-image" title="{{ $barang->nama }}">
