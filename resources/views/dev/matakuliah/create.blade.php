...
<section class="section">
  ...
  <div class="section-body">
    <div class="card">
      ...
      <form action="{{ url('dev/matakuliah') }}" method="POST" autocomplete="off">
        @csrf
        <div class="card-body">
          <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select class="form-control selectric @error('prodi_id') is-invalid @enderror" name="prodi_id" id="prodi_id"
                  required>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select class="form-control selectric @error('semester') is-invalid @enderror" name="semester" id="semester"
                  required>
