                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center w-25">
                      <form action="{{ url('dev/bahan/' . $bahan->id) }}" method="post" id="del-{{ $bahan->id }}">
                        @csrf
                        @method('delete')
                        <a href="{{ url('dev/bahan/' . $bahan->id) }}" class="btn btn-info">
                          <i class="fas fa-eye"></i>
                        </a>
                        <a href="{{ url('dev/bahan/' . $bahan->id . '/edit') }}" class="btn btn-warning">
