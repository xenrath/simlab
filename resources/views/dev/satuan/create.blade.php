                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="custom-select custom-select-sm" name="kategori" id="kategori">
                                ...
                                <option value="volume" {{ old('kategori') == 'volume' ? 'selected' : null }}>Volume</option>
                                <option value="berat" {{ old('kategori') == 'berat' ? 'selected' : null }}>Berat</option>
                                <option value="bahan" {{ old('kategori') == 'bahan' ? 'selected' : null }}>Bahan</option>
                            </select>
                        </div>
                    </div>
