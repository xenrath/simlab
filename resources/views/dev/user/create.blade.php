            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-control @error('prodi') is-invalid @enderror" name="subprodi_id"
                    id="subprodi_id">
...
<script>
  ...
  var layoutprodi = document.getElementById('layoutprodi');
  var subprodi_id = document.getElementById('subprodi_id');
  var semester = document.getElementById('semester');

  function clickrole() {
    if (role.value == 'peminjam') {
      layoutprodi.style.display = "inline";
      console.log(subprodi_id.value);
      semester.value = "";
    } else {
      layoutprodi.style.display = "none";
      console.log(subprodi_id.value);
      subprodi_id.value = "";
      semester.value = "";
    }
