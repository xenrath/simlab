...
<section class="section">
  <div class="section-header">
    <div class="section-header-back">
      <a href="{{ url('pinjam/' . lcfirst($prodi->nama)) }}" class="btn btn-secondary">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    $('#keyword').on('keyup', function () {
      ...
      if ($value) {
        $('#modalDataAll').hide();
        $('#modalDataSearch').show();
      } else {
        $('#modalDataAll').show();
        $('#modalDataSearch').hide();
      }
      $.ajax({
        url: "{{ url('search-barang-bidan/' . $prodi->nama) }}",
        type: "GET",
        data: { "keyword": $value },
        success: function(data) {
          console.log(data);
          $('#modalDataSearch').html(data);
        },
      });
    });
  });
