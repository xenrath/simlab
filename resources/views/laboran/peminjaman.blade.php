        ...
        <table class="table table-striped">
          ...
          <tr>
            ...
            <td class="text-center align-middle">
              <a href="{{ url('laboran/peminjaman/detail/' . $pinjam->id) }}" class="btn btn-info">
                <i class="fas fa-eye"></i>
                <span class="d-none d-md-inline">&nbsp;Lihat</span>
              </a>
            </td>
            <td class="text-center align-middle">
              <a href="{{ url('laboran/peminjaman/setujui/' . $pinjam->id) }}" class="btn btn-primary mr-1">
                <span class="d-none d-md-inline">Setujui&nbsp;</span>
                <i class="fas fa-check"></i>
              </a>
              <a href="{{ url('laboran/peminjaman/tolak/' . $pinjam->id) }}" class="btn btn-danger">
