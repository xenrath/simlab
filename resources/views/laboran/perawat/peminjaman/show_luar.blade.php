    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="{{ url('laboran/perawat/peminjaman') }}" class="btn btn-secondary rounded-0">
        ...
        <div class="section-body">
            <div class="text-right mb-3">
                <form action="{{ url('laboran/perawat/peminjaman/setujui/' . $pinjam->id) }}" method="get"
                    id="form-konfirmasi">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content rounded-0">
                ...
                <div class="modal-footer bg-whitesmoke justify-content-between">
                    ...
                    <form action="{{ url('laboran/perawat/peminjaman/' . $pinjam->id) }}" method="POST" id="form-hapus">
                        @csrf
                        @method('delete')
