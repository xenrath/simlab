    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="{{ url('laboran/perawat/bahan-pemasukan') }}" class="btn btn-secondary rounded-0">
        ...
        <div class="section-body">
            <form action="{{ url('laboran/perawat/bahan-pemasukan/manual') }}" method="POST" autocomplete="off" id="form-submit">
                @csrf
...
@section('script')
    <script>
        ...
        function bahan_cari() {
            ...
            $.ajax({
                url: "{{ url('laboran/perawat/bahan-cari') }}",
                type: "GET",
                data: {
        ...
        function bahan_tambah(id) {
            ...
            if (check) {
                if (!bahan_item.includes(id)) {
                    ...
                    $.ajax({
                        url: "{{ url('laboran/perawat/bahan-tambah') }}" + '/' + id,
                        type: "GET",
                        dataType: "json",
                        success: function(data) {
                            bahan_set(key, data);
