    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="{{ url('laboran/farmasi/bahan-pemasukan') }}" class="btn btn-secondary rounded-0">
        ...
        <div class="section-body">
            <form action="{{ url('laboran/farmasi/bahan-pemasukan/manual') }}" method="POST" autocomplete="off" id="form-submit">
                @csrf
...
@section('script')
    <script>
        ...
        function bahan_cari() {
            ...
            $.ajax({
                url: "{{ url('laboran/farmasi/bahan-cari') }}",
                type: "GET",
                data: {
        ...
        function bahan_tambah(id) {
            ...
            if (check) {
                if (!bahan_item.includes(id)) {
                    ...
                    $.ajax({
                        url: "{{ url('laboran/farmasi/bahan-tambah') }}" + '/' + id,
                        type: "GET",
                        dataType: "json",
                        success: function(data) {
                            bahan_set(key, data);
