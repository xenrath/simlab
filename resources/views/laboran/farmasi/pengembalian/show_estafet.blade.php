                            ...
                            <table class="table table-striped table-bordered table-md mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" style="width: 120px">Pelaku</th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-top">
                                                <button type="button"
                                                    ...
                                                    Pilih
                                                    <span id="span-pelaku-{{ $detail_pinjam->id }}"></span>
                                                </button>
                ...
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-body">
                        <div class="form-group mb-2">
                            <label>Pilih Pelaku</label>
                            <select class="form-control select2 is-invalid" multiple=""
                        ...
                        <small class="text-muted">
                            * Pilih siapa saja yang bertanggung jawab atas barang rusak ini.
                            Bisa pilih lebih dari satu orang.
                        </small>
                    </div>
...
@section('script')
    ...
    <script>
        function pelaku_set(id) {
            ...
            if (pelaku_modal.length > 0) {
                $('#span-pelaku-' + id).text('(' + pelaku_modal.length + ')');
            }
        }
