    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="{{ url('laboran/k3/bahan-pengeluaran') }}" class="btn btn-secondary rounded-0">
        ...
        <div class="section-body">
            <form action="{{ url('laboran/k3/bahan-pengeluaran/manual') }}" method="POST" autocomplete="off"
                id="form-submit">
                @csrf
