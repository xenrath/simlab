    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-button">
                <a href="{{ url('laboran/k3/bahan/create') }}" class="btn btn-primary rounded-0">Tambah</a>
            </div>
        </div>
        <div class="section-body">
            <div class="card rounded-0 mb-3">
                <div class="card-header">
                    ...
                    <div class="card-header-action dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-sm dropdown-menu-right rounded-0">
                            <li>
                                <a href="{{ url('laboran/k3/bahan-pemasukan') }}" class="dropdown-item">
                                    <i class="fas fa-sign-in-alt mr-1"></i> Pemasukan
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('laboran/k3/bahan-pengeluaran') }}" class="dropdown-item">
                ...
                <div class="card-body">
                    <form action="{{ url('laboran/k3/bahan') }}" method="get" id="form-filter">
                                ...
                                @forelse($bahans as $key => $bahan)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{ url('laboran/k3/bahan/' . $bahan->id . '/edit') }}"
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="modal-cetak-{{ $bahan->id }}">
            <div class="modal-dialog" role="document">
                <div class="modal-content rounded-0">
                    ...
                    <form action="{{ url('laboran/k3/bahan/cetak/' . $bahan->id) }}" method="POST"
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="modal-hapus-{{ $bahan->id }}">
            <div class="modal-dialog" role="document">
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-footer bg-whitesmoke justify-content-between">
                        <button type="button" class="btn btn-secondary rounded-0" data-dismiss="modal">Batal</button>
                        <form action="{{ url('laboran/k3/bahan/' . $bahan->id) }}" method="POST"
