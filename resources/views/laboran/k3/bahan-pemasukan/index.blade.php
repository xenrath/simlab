    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="card rounded-0 mb-3">
                ...
                <div class="card-body">
                    <form action="{{ url('laboran/k3/bahan-pemasukan') }}" method="get" id="form-filter">
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="modal-tambah">
        <div class="modal-dialog" role="document">
            <div class="modal-content rounded-0">
                ...
                <form action="{{ url('laboran/k3/bahan-pemasukan/create') }}" method="GET" id="form-tambah">
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="modal-hapus-{{ $rekap_bahan->id }}">
            <div class="modal-dialog" role="document">
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-footer bg-whitesmoke justify-content-between">
                        <button type="button" class="btn btn-secondary rounded-0" data-dismiss="modal">Batal</button>
                        <form action="{{ url('laboran/k3/bahan-pemasukan/' . $rekap_bahan->id) }}" method="POST"
