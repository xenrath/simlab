    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="{{ url('laboran/k3/bahan-pemasukan') }}" class="btn btn-secondary rounded-0">
        ...
        <div class="section-body">
            <form action="{{ url('laboran/k3/bahan-pemasukan/manual') }}" method="POST" autocomplete="off" id="form-submit">
                @csrf
        ...
        function bahan_tambah(id) {
            ...
            if (check) {
                if (!bahan_item.includes(id)) {
                    ...
                    $.ajax({
                        url: "{{ url('laboran/k3/bahan-tambah') }}" + '/' + id,
                        type: "GET",
                        dataType: "json",
                        success: function(data) {
                            bahan_set(key, data);
