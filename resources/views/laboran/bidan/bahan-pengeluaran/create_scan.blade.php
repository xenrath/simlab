    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="{{ url('laboran/bidan/bahan-pengeluaran') }}" class="btn btn-secondary rounded-0">
        ...
        <div class="section-body">
            ...
            <div class="card rounded-0 mb-3">
                ...
                <form action="{{ url('laboran/bidan/bahan-pengeluaran/scan') }}" method="POST" autocomplete="off"  id="form-submit">
                    @csrf
...
@section('script')
    <script>
        ...
        $('#form-tambah').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ url('laboran/bidan/bahan-scan') }}" + '/' + kode,
                type: "GET",
                dataType: "json",
