    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="{{ url('laboran/bidan/pengembalian') }}" class="btn btn-secondary rounded-0">
        ...
        <div class="section-body">
            ...
            <div class="card rounded-0 mb-3">
                ...
                <form action="{{ url('laboran/bidan/pengembalian/' . $pinjam->id) }}" method="POST" id="form-submit">
                    @csrf
                    @method('PUT')
