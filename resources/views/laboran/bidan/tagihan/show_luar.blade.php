    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="{{ url('laboran/bidan/tagihan') }}" class="btn btn-secondary rounded-0">
        ...
        <div class="section-body">
            ...
            <div class="card rounded-0 mb-3">
                ...
                <form action="{{ url('laboran/bidan/tagihan/' . $pinjam->id) }}" method="POST" autocomplete="off"
                    id="form-submit">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-md mb-0">
                                    ...
                                    <tbody>
                                        @forelse ($tagihan_peminjamans as $tagihan_peminjaman)
                                            <tr>
                                                <td class="text-center align-middle">{{ $loop->iteration }}</td>
                                                <td>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="4" class="text-center text-muted">- Data tidak ditemukan -
                                                </td>
                                            </tr>
                                        @endforelse
                                    </tbody>
