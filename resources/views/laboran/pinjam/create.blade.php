...
<section class="section">
  ...
  <div class="section-body">
    <form action="{{ url('laboran/pinjam/' . $pinjam->id) }}" method="POST" autocomplete="off" id="form_pinjam">
      @csrf
      @method('put')
      <div class="row">
        <div class="col-12">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="time" class="form-control @error('jam_awal') is-invalid @enderror" name="jam_awal"
                      id="jam_awal" value="{{ old('jam_awal', $pinjam->jam_awal) }}" min="07:00:00" max="17:00:00">
                    @error('jam_awal')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="time" class="form-control @error('jam_akhir') is-invalid @enderror" name="jam_akhir"
                      id="jam_akhir" value="{{ old('jam_akhir', $pinjam->jam_akhir) }}">
                    @error('jam_akhir')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select class="form-control selectric @error('ruang_id') is-invalid @enderror" id="ruang_id"
                      ...
                      <option value="{{ $ruang->id }}" {{ old('ruang_id', $pinjam->ruang_id)==$ruang->id ? 'selected' :
                        '' }}>{{
                        $ruang->nama }}</option>
                      @empty
          ...
          <div class="card mt-3">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <textarea class="form-control" id="bahan" name="bahan"
...
<div class="modal fade" id="modalKelompok" role="dialog" aria-labelledby="modalKelompok" aria-hidden="true">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      ...
      <form action="{{ url('laboran/kelompok') }}" method="POST" autocomplete="off">
        @csrf
        <div class="modal-body">
              ...
              $("#dataItems").append("<tr>\
                ...
                <td>\
                  <div class='input-group'>\
                    <input class='form-control' type='number' id='jumlahId' name='jumlah[" + key + "]' oninput='this.value = !!this.value && Math.abs(this.value) > 0 && !!this.value && Math.abs(this.value) <= " + value.normal + " ? Math.abs(this.value) : null' required>\
