  ...
  <section class="section">
    <div class="section-header">
      <div class="section-header-back">
        <a href="{{ url('peminjam/normal/pengembalian-new') }}" class="btn btn-secondary">
    ...
    <div class="section-body">
      ...
      <form action="{{ url('peminjam/normal/pengembalian-new/' . $pinjam->id) }}" method="POST" id="form-submit">
        @csrf
        @method('PUT')
        <div class="card">
          <div class="card-header">
              ...
              $.each(data, function(key, value) {
                $("#dataItems").append("<tr>\
                  ...
                  value.normal + " ? Math.abs(this.value) : null' value='1' required>\
                                                  <input type='hidden' name='barang_id[" + key + "]' value='" + value
