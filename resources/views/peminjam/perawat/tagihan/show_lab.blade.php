    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="{{ url('peminjam/perawat/tagihan') }}" class="btn btn-secondary">
                    ...
                    <table class="table table-bordered table-md">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" style="width: 40px">Rusak</th>
                                <th class="text-center" style="width: 40px">Hilang</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($detail_pinjams as $detail_pinjam)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ $detail_pinjam->rusak == 0 ? '-' : $detail_pinjam->rusak }}
                                    </td>
                                    <td class="text-center">
                                        {{ $detail_pinjam->hilang == 0 ? '-' : $detail_pinjam->hilang }}
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
