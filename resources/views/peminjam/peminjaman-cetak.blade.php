...
<body>
  ...
  <h3 style="text-align: center">
    <u>DAFTAR PEMINJAMAN BARANG / BAHAN</u>
  </h3>
  <br>
  ...
  <table style="width: 100%;" class="table-1" cellspacing="0" cellpadding="8">
    ...
    <tr>
      ...
      <td class="td-1" width="20px" style="text-align: center">:</td>
      <td class="td-1">{{ $pinjam->peminjam->prodi->jenjang }} {{ $pinjam->peminjam->prodi->nama }}</td>
    </tr>
    {{-- <tr>
  ...
  <p>
    <strong>Daftar barang / bahan yang dipinjam :</strong>
  </p>
  <br>
  @if (count($barangs) > 0)
  <p>&bull;&nbsp;&nbsp;Barang</p>
  ...
  <table style="width: 100%;" class="table-1" cellspacing="0" cellpadding="8">
    <tr>
      <th class="th-1">No.</th>
      <th class="th-1 text-left">Nomor Inventaris</th>
      <th class="th-1 text-left">Nama Bahan</th>
      <th class="th-1">Jumlah</th>
    </tr>
    ...
    <tr>
      ...
      <td class="td-1 text-center">{{ $bahan->jumlah }} {{ ucfirst($bahan->barang->satuan->nama) }}</td>
    </tr>
    @endforeach
  </table>
  @endif
