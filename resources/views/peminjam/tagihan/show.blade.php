              ...
              <tbody>
                @foreach ($rusaks as $rusak)
                  <tr>
                    ...
                    <td>{{ $rusak->barang->ruang->nama }}</td>
                    <td>Rusak</td>
                    <td class="text-center">{{ $rusak->rusak }} {{ ucfirst($rusak->satuan->nama) }}
                    </td>
                  </tr>
                @endforeach
                @foreach ($hilangs as $hilang)
                  <tr>
                    ...
                    <td>{{ $hilang->barang->ruang->nama }}</td>
                    <td>Hilang</td>
                    <td class="text-center">{{ $hilang->hilang }} {{ ucfirst($hilang->satuan->nama) }}
                    </td>
                  </tr>
                @endforeach
              </tbody>
