  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-button"> 
        <a href="{{ url('peminjam/pinjam/kelompok/create') }}" class="btn btn-primary">Tambah Peminjaman</a>
      </div>
    </div>
    @if (session('error'))
                      ...
                      <tr>
                        ...
                        <td class="text-center align-top py-3">
                          @if ($pinjam->peminjam_id == auth()->user()->id)
                            <form action="{{ url('peminjam/pinjam/kelompok/' . $pinjam->id) }}" method="POST"
                              id="del-{{ $pinjam->id }}">
                              @csrf
                              @method('delete')
                              <a href="{{ url('peminjam/pinjam/kelompok/' . $pinjam->id . '/edit') }}"
                          ...
                          @else
                            <a href="{{ url('peminjam/pinjam/kelompok/' . $pinjam->id) }}" class="btn btn-info">
