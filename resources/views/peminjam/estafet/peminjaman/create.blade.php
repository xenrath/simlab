                ...
                <div class="row">
                    <div class="col-12">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectric" id="waktu" name="waktu">
                                        ...
                                        <option value="1" {{ old('waktu', '1') == '1' ? 'selected' : '' }}>Besok
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectric" id="ruang_id" name="ruang_id">
                                        ...
                                        @forelse ($ruangs as $ruang)
                                            <option value="{{ $ruang->id }}"
                                                ...
                                                {{ $ruang->nama }}</option>
                                        @empty
                                            <option value="" class="text-center" disabled>Ruang / Lab. tidak ditemukan
                                            </option>
                                        @endforelse
                                    </select>
                                </div>
                                        ...
                                        <tbody id="tbodykelompok">
                                            @forelse ($kelompoks as $kelompok)
                                                <tr id="rowkelompok{{ $kelompok->id }}">
                                                    ...
                                                    <td class="py-3">
                                                        <span class="bullet"></span>&nbsp;{{ $kelompok->m_ketua->nama }}
                                                        (Ketua)
                                                        <br>
                                                    ...
                                                    <td class="align-top py-3">
                                                        <button type="button" class="btn btn-danger"
                                                            onclick="hapusKelompok({{ $kelompok->id }})">
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="5" class="text-center">- Kelompok belum ditambahkan -
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                                        ...
                                        <tbody id="dataItems">
                                            @forelse ($detailpinjams as $detailpinjam)
                                                <tr>
                                                    ...
                                                    <td>{{ $detailpinjam->barang->normal }}
                                                        {{ $detailpinjam->barang->satuan->singkatan }}</td>
                                                    <td>{{ $detailpinjam->jumlah }} {{ $detailpinjam->satuan->singkatan }}
                                                    </td>
                                                </tr>
                                            @empty
                                                <tr>
                                                    <td colspan="5" class="text-center">Belum ada barang yang dipilih
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                        ...
                        <div class="float-right">
                            <button type="button" class="btn btn-primary" onclick="form_submit('false')">Buat
                                Pinjaman</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <input class="form-check-input" type="checkbox" id="checkboxId" value="{{ $barang->id }}">
                                        ...
                                        <td class="text-center">{{ $barang->normal }} {{ $barang->satuan->singkatan }}
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
        ...
        <div class="modal fade" id="modalKelompok" role="dialog" aria-labelledby="modalKelompok" aria-hidden="true">
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <input type="hidden" class="form-control" name="pinjam_id" id="pinjam_id"
                            value="{{ $pinjam->id }}">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="anggota_kelompok[]" id="anggota_kelompok"
                                multiple="">
                                @foreach ($peminjams as $peminjam)
                                    <option value="{{ $peminjam->kode }}">{{ $peminjam->kode }} - {{ $peminjam->nama }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
