    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="{{ url('peminjam/farmasi/riwayat') }}" class="btn btn-secondary rounded-0">
                    ...
                    <table class="table table-bordered table-striped table-md mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" style="width: 80px">Rusak</th>
                                <th class="text-center" style="width: 80px">Hilang</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($detail_pinjams as $detail_pinjam)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $detail_pinjam->rusak }} Pcs</td>
                                    <td class="text-center">{{ $detail_pinjam->hilang }} Pcs</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
