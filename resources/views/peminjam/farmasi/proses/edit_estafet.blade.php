...
@section('content')
    <section class="section">
        ...
        <div class="section-body">
            ...
            <form action="{{ url('peminjam/farmasi/proses/' . $pinjam->id) }}" method="POST" autocomplete="off"
                id="form-submit">
                @csrf
                @method('put')
    ...
    <div class="modal fade" id="modal-estafet" data-backdrop="static" role="dialog" aria-labelledby="modal-estafet">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content rounded-0">
                ...
                <div class="modal-body">
                    @forelse ($estafets as $estafet)
                        <div class="card border rounded-0 shadow-sm mb-2">
                            <div
                                class="card-body d-flex align-center justify-content-between align-items-center py-2 px-3 mb-0">
                                <div>
                                    <strong>
                                        {{ $estafet->peminjam->kode }} | {{ $estafet->peminjam->nama }}
                                    </strong>
                                    <br>
                                    <span>{{ Carbon\Carbon::parse($estafet->tanggal_awal)->translatedFormat('d F Y') }}</span>
                                    <br>
                                    <span>{{ $estafet->jam_awal }}-{{ $estafet->jam_akhir }} WIB</span>
                                    <br>
                    ...
                    @empty
                        <div id="modal-card-estafet-empty" class="card border rounded-0 mb-0">
                            <div class="card-body text-center">
                                <span class="text-muted">- Data tidak ditemukan -</span>
                            </div>
                        </div>
