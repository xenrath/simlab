                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu rounded-0">
                                        <a class="dropdown-item"
                                            href="{{ url('peminjam/k3/menunggu/' . $pinjam->id) }}">Lihat</a>
                                        @if ($pinjam->peminjam_id == auth()->user()->id)
                                            @if ($pinjam->praktik_id != 4)
                                                <a class="dropdown-item"
                                                    href="{{ url('peminjam/k3/menunggu/' . $pinjam->id . '/edit') }}">Edit</a>
                                            @endif
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-footer bg-whitesmoke justify-content-between">
                        ...
                        <form action="{{ url('peminjam/k3/menunggu/' . $pinjam->id) }}" method="POST"
