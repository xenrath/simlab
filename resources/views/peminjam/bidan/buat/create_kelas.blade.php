                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control selectric" name="jam" id="jam" onchange="customJam()">
                                ...
                                <option value="lainnya" {{ $jam == 'lainnya' ? 'selected' : '' }}>
                                    Jam Lainnya
                                </option>
                            </select>
                        </div>
                        ...
                        <input type="hidden" name="praktik_id" class="form-control" value="2">
                    </div>
                </div>
                @if ($error_anggota)
                    <div class="alert alert-danger alert-dismissible show fade">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <button type="button" class="btn btn-info" data-toggle="modal"
                                data-target="#modalBarang">Pilih Barang</button>
                        </div>
                    </div>
                </div>
                <div class="card mb-2" id="card_barang_kosong">
