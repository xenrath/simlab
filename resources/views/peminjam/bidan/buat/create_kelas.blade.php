    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="{{ url('peminjam/bidan/buat') }}" class="btn btn-secondary rounded-0">
                    <i class="fas fa-arrow-left"></i>
                </a>
            </div>
            <h1>Praktik Dalam Kelas</h1>
        </div>
        <div class="section-body">
            <form action="{{ url('peminjam/bidan/buat/praktik-kelas') }}" method="POST" autocomplete="off" id="form-submit">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="card rounded-0 mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <select class="form-control rounded-0 @error('laboran_id') is-invalid @enderror"
                                        id="laboran_id" name="laboran_id">
                                        <option value="">- Pilih -</option>
...
@section('script')
    ...
    <script>
        ...
        function anggota_cari() {
            ...
            $.ajax({
                url: "{{ url('peminjam/bidan/anggota-cari') }}",
                type: "GET",
                data: {
        ...
        function anggota_tambah(is_old = false) {
            ...
            $.ajax({
                url: "{{ url('peminjam/bidan/anggota-tambah') }}",
                type: "POST",
                data: {
                    "_token": "{{ csrf_token() }}",
    ...
    <script>
        ...
        function barang_cari() {
            ...
            $.ajax({
                url: "{{ url('peminjam/bidan/barang-cari') }}",
                type: "GET",
                data: {
        ...
        function barang_tambah(id) {
            ...
            if (check) {
                if (!barang_item.includes(id)) {
                    ...
                    $.ajax({
                        url: "{{ url('peminjam/bidan/barang-tambah') }}" + '/' + id,
                        type: "GET",
                        dataType: "json",
                        success: function(data) {
                            barang_set(key, data);
