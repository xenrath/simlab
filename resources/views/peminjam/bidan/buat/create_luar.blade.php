...
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            <h1>Praktik Klinik / Rumah Sakit / PKL</h1>
        </div>
        <div class="section-body">
            <form action="{{ url('peminjam/bidan/buat/praktik-luar') }}" method="POST" autocomplete="off" id="form-submit">
                @csrf
                <div class="card rounded-0 mb-3">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-2">
                            ...
                            <input type="date" class="form-control rounded-0 @error('tanggal_awal') is-invalid @enderror"
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="date"
                                ...
                                id="tanggal_akhir" name="tanggal_akhir" min="{{ date('Y-m-d') }}"
