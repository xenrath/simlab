            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1 mb-3">
                        ...
                        <div class="card-wrap">
                            <a href="{{ url('peminjam/labterpadu/menunggu') }}">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1 mb-3">
                        ...
                        <div class="card-wrap">
                            <a href="{{ url('peminjam/labterpadu/proses') }}">
                                <div class="card-header">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1 mb-3">
                        ...
                        <div class="card-wrap">
                            <a href="{{ url('peminjam/labterpadu/riwayat') }}">
                                <div class="card-header">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1 mb-3">
                        ...
                        <div class="card-wrap">
                            <a href="{{ url('peminjam/labterpadu/tagihan') }}">
                                <div class="card-header">
