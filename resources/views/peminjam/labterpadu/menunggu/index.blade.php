                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu rounded-0">
                                        <a class="dropdown-item"
                                            href="{{ url('peminjam/labterpadu/menunggu/' . $pinjam->id) }}">Lihat</a>
                                        @if ($pinjam->peminjam_id == auth()->user()->id)
                                            @if ($pinjam->praktik_id != 4)
                                                <a class="dropdown-item"
                                                    href="{{ url('peminjam/labterpadu/menunggu/' . $pinjam->id . '/edit') }}">Edit</a>
                                            @endif
                                            <a class="dropdown-item" href="#" data-toggle="modal"
                                                data-target="#modal-hapus-{{ $pinjam->id }}">Hapus</a>
                                            <form action="{{ url('peminjam/labterpadu/menunggu/' . $pinjam->id) }}"
