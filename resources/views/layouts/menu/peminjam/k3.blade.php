...
<li class="{{ request()->is('peminjam/k3') ? 'active' : '' }}">
    <a class="nav-link rounded-0" href="{{ url('peminjam/k3') }}">
...
<li class="{{ request()->is('peminjam/k3/buat*') ? 'active' : '' }}">
    <a class="nav-link rounded-0" href="{{ url('peminjam/k3/buat') }}">
        <i class="fas fa-plus"></i>
        <span>Buat Peminjaman</span>
    </a>
</li>
<li class="{{ request()->is('peminjam/k3/menunggu*') ? 'active' : '' }}">
    <a class="nav-link rounded-0" href="{{ url('peminjam/k3/menunggu') }}">
        <i class="fas fa-clock"></i>
        <span>Menunggu</span>
    </a>
</li>
<li class="{{ request()->is('peminjam/k3/proses*') ? 'active' : '' }}">
    <a class="nav-link rounded-0" href="{{ url('peminjam/k3/proses') }}">
        <i class="fas fa-tasks"></i>
        <span>Dalam Peminjaman</span>
    </a>
</li>
<li class="{{ request()->is('peminjam/k3/riwayat*') ? 'active' : '' }}">
    <a class="nav-link rounded-0" href="{{ url('peminjam/k3/riwayat') }}">
        <i class="fas fa-history"></i>
        <span>Riwayat</span>
    </a>
</li>
<li class="{{ request()->is('peminjam/k3/tagihan*') ? 'active' : '' }}">
    <a class="nav-link rounded-0" href="{{ url('peminjam/k3/tagihan') }}">
