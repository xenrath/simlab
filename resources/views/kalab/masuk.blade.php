  ...
  <div class="section-body">
    <div class="card">
      ...
      <div class="card-body p-0">
        <div class="p-4">
          <form action="{{ url('kalab/masuk') }}" method="get" id="get-filter">
          ...
          <table class="table table-striped">
            ...
            <tbody id="data-barang">
              ...
              <tr>
                ...
                <td class="text-center">{{ $barang->stok }} {{ $barang->satuan->nama }}</td>
                <td class="text-center">{{ date('d/m/Y', strtotime($barang->created_at)) }}</td>
                <td class="text-center">
                  <a href="{{ url('kalab/masuk/detail/' . $barang->id) }}" class="btn btn-info">
