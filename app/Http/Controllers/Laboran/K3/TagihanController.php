...
class TagihanController extends Controller
{
    public function index()
    {
        ...
        return view('laboran.k3.tagihan.index', compact('pinjams'));
    }
    ...
    public function show_lab($id)
    {
        ...
        return view('laboran.k3.tagihan.show_lab', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
            'tagihan_peminjamans',
    ...
    public function show_kelas($id)
    {
        ...
        return view('laboran.k3.tagihan.show_kelas', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
            'tagihan_peminjamans',
    ...
    public function show_luar($id)
    {
        ...
        return view('laboran.k3.tagihan.show_luar', compact(
            'pinjam',
            'detail_pinjams',
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('laboran/k3/tagihan')->with('success', 'Berhasil mengonfirmasi Tagihan');
    }
}
