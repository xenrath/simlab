...
class TagihanController extends Controller
{
    public function index()
    {
        ...
        return view('laboran.perawat.tagihan.index', compact('pinjams'));
    }
    ...
    public function show_lab($id)
    {
        ...
        return view('laboran.perawat.tagihan.show_lab', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
            'tagihan_peminjamans',
    ...
    public function show_kelas($id)
    {
        ...
        return view('laboran.perawat.tagihan.show_kelas', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
            'tagihan_peminjamans',
    ...
    public function show_luar($id)
    {
        ...
        return view('laboran.perawat.tagihan.show_luar', compact(
            'pinjam',
            'detail_pinjams',
            'tagihan_peminjamans',
            'tagihan_detail'
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('laboran/perawat/tagihan')->with('success', 'Berhasil mengonfirmasi Tagihan');
    }
}
