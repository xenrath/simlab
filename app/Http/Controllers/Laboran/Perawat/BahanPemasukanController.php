...
class BahanPemasukanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('laboran.perawat.bahan-pemasukan.index', compact('rekap_bahans'));
    }
    ...
    public function create()
    {
        ...
        switch ($metode) {
            case 'manual':
                return redirect('laboran/perawat/bahan-pemasukan/manual');
            case 'scan':
                return redirect('laboran/perawat/bahan-pemasukan/scan');
            default:
    ...
    public function create_manual()
    {
        ...
        return view('laboran.perawat.bahan-pemasukan.create_manual', compact('bahans'));
    }

    public function create_scan()
    {
        return view('laboran.perawat.bahan-pemasukan.create_scan');
    }
    ...
    public function store_manual(Request $request)
    {
        ...
        return redirect('laboran/perawat/bahan-pemasukan')->with('success', 'Berhasil membuat Pemasukan Bahan');
    }
    ...
    public function store_scan(Request $request)
    {
        ...
        return redirect('laboran/perawat/bahan-pemasukan')
