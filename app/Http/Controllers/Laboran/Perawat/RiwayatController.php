...
class RiwayatController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('laboran.perawat.riwayat.index', compact('pinjams'));
    }
    ...
    public function show_lab($id)
    {
        ...
        return view('laboran.perawat.riwayat.show_lab', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
            'tagihan_peminjamans'
    ...
    public function show_kelas($id)
    {
        ...
        return view('laboran.perawat.riwayat.show_kelas', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
            'tagihan_peminjamans'
    ...
    public function show_luar($id)
    {
        ...
        return view('laboran.perawat.riwayat.show_luar', compact(
            'pinjam',
            'detail_pinjams',
            'tagihan_peminjamans'
        ));
    ...
    public function show_ruang($id)
    {
        ...
        return view('laboran.perawat.riwayat.show_ruang', compact('pinjam', 'data_kelompok', 'detail_pinjams'));
    }
}
