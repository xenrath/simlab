...
class BahanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('laboran.perawat.bahan.index', compact('bahans'));
    }
    ...
    public function create()
    {
        ...
        return view('laboran.perawat.bahan.create', compact('prodi'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('laboran/perawat/bahan')->with('success', 'Berhasil menambahkan Bahan');
    }
    ...
    public function edit($id)
    {
        ...
        return view('laboran.perawat.bahan.edit', compact('bahan', 'prodi'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('laboran/perawat/bahan')->with('success', 'Berhasil memperbarui Bahan');
    }
    ...
    public function cetak(Request $request, $id)
    {
        ...
        $pdf = Pdf::loadview('laboran.perawat.bahan.cetak', compact('bahan', 'jumlah'));
