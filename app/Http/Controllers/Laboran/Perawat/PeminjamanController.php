...
class PeminjamanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('laboran.perawat.peminjaman.index', compact('pinjams'));
    }
    ...
    public function show_lab($id)
    {
        ...
        return view('laboran.perawat.peminjaman.show_lab', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
        ));
    ...
    public function show_kelas($id)
    {
        ...
        return view('laboran.perawat.peminjaman.show_kelas', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
        ));
    ...
    public function show_luar($id)
    {
        ...
        return view('laboran.perawat.peminjaman.show_luar', compact(
            'pinjam',
            'detail_pinjams',
        ));
    }
    ...
    public function show_ruang($id)
    {
        ...
        return view('laboran.perawat.peminjaman.show_ruang', compact('pinjam', 'data_kelompok'));
    }
    ...
    public function setujui($id)
    {
        ...
        return redirect('laboran/perawat/peminjaman')->with('success', 'Berhasil menyetujui Peminjaman');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('laboran/perawat/peminjaman')->with('success', 'Berhasil menghapus Peminjaman');
    }
}
