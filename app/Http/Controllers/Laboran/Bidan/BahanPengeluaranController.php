...
class BahanPengeluaranController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('laboran.bidan.bahan-pengeluaran.index', compact('rekap_bahans'));
    }
    ...
    public function create()
    {
        ...
        switch ($metode) {
            case 'manual':
                return redirect('laboran/bidan/bahan-pengeluaran/manual');
            case 'scan':
                return redirect('laboran/bidan/bahan-pengeluaran/scan');
            default:
    ...
    public function create_manual()
    {
        ...
        return view('laboran.bidan.bahan-pengeluaran.create_manual', compact('bahans'));
    }

    public function create_scan()
    {
        return view('laboran.bidan.bahan-pengeluaran.create_scan');
    }
    ...
    public function store_manual(Request $request)
    {
        ...
        return redirect('laboran/bidan/bahan-pengeluaran')->with('success', 'Berhasil membuat Pengeluaran Bahan');
    }
    ...
    public function store_scan(Request $request)
    {
        ...
        return redirect('laboran/bidan/bahan-pengeluaran')
