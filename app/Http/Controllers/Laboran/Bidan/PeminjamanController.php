...
class PeminjamanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('laboran.bidan.peminjaman.index', compact('pinjams'));
    }
    ...
    public function show_lab($id)
    {
        ...
        return view('laboran.bidan.peminjaman.show_lab', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
        ));
    ...
    public function show_kelas($id)
    {
        ...
        return view('laboran.bidan.peminjaman.show_kelas', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
        ));
    ...
    public function show_luar($id)
    {
        ...
        return view('laboran.bidan.peminjaman.show_luar', compact(
            'pinjam',
            'detail_pinjams',
        ));
    }
    ...
    public function show_ruang($id)
    {
        ...
        return view('laboran.bidan.peminjaman.show_ruang', compact('pinjam', 'data_kelompok'));
    }
    ...
    public function setujui($id)
    {
        ...
        return redirect('laboran/bidan/peminjaman')->with('success', 'Berhasil menyetujui Peminjaman');
    }
    ...
    public function tolak($id)
    {
        ...
        if (!$updated) {
            return redirect('laboran/bidan/peminjaman')->with('error', 'Gagal menolak Peminjaman!');
        }

        return redirect('laboran/bidan/peminjaman')->with('success', 'Berhasil menolak Peminjaman');
    }
