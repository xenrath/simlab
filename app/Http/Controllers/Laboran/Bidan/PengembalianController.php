...
class PengembalianController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('laboran.bidan.pengembalian.index', compact('pinjams'));
    }
    ...
    public function show_lab($id)
    {
        ...
        return view('laboran.bidan.pengembalian.show_lab', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
        ));
    ...
    public function show_kelas($id)
    {
        ...
        return view('laboran.bidan.pengembalian.show_kelas', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
        ));
    ...
    public function show_luar($id)
    {
        ...
        return view('laboran.bidan.pengembalian.show_luar', compact(
            'pinjam',
            'detail_pinjams',
        ));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('laboran/bidan/pengembalian')->with('success', 'Berhasil mengkonfirmasi peminjaman');
    }
