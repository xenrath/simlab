...
class LaporanController extends Controller
{
    public function index()
    {
        ...
        return view('laboran.bidan.laporan.index', compact('pinjams'));
    }
    ...
    public function show_lab($id)
    {
        ...
        return view('laboran.bidan.laporan.show_lab', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
            'tagihan_peminjamans'
    ...
    public function show_kelas($id)
    {
        ...
        return view('laboran.bidan.laporan.show_kelas', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
            'tagihan_peminjamans'
    ...
    public function show_luar($id)
    {
        ...
        return view('laboran.bidan.laporan.show_luar', compact(
            'pinjam',
            'detail_pinjams',
            'tagihan_peminjamans'
        ));
    ...
    public function show_ruang($id)
    {
        ...
        return view('laboran.bidan.laporan.show_ruang', compact('pinjam', 'data_kelompok', 'detail_pinjams'));
    }
    ...
    public function print_o()
    {
        ...
        $pdf = Pdf::loadview('laboran.bidan.laporan.print', compact('pinjams'));
        $pdf->output();
    ...
    public function print(Request $request)
    {
        ...
        $pdf = Pdf::loadview('laboran.bidan.laporan.print', compact('pinjams', 'tanggal_awal', 'tanggal_akhir'));
        return $pdf->stream('Laporan Peminjaman');
    }
}
