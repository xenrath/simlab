...
class BuatController extends Controller
{
    ...
    public function create_lab()
    {
        ...
        return view('peminjam.k3.buat.create_lab', compact('praktik', 'ruangs', 'barangs', 'peminjams'));
    }
    ...
    public function create_kelas()
    {
        ...
        return view('peminjam.k3.buat.create_kelas', compact('praktik', 'laborans', 'barangs', 'peminjams'));
    }
    ...
    public function create_luar()
    {
        ...
        return view('peminjam.k3.buat.create_luar', compact('praktik', 'laborans', 'barangs', 'peminjams'));
    }
    ...
    public function create_ruang()
    {
        ...
        return view('peminjam.k3.buat.create_ruang', compact('praktik', 'ruangs', 'peminjams'));
    }
