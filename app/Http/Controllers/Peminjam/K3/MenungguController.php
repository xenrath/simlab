...
class MenungguController extends Controller
{
    ...
    public function show_ruang($id)
    {
        ...
        return view('peminjam.k3.menunggu.show_ruang', compact('pinjam', 'data_kelompok'));
    }
    ...
    public function edit_lab($id)
    {
        ...
        return view('peminjam.k3.menunggu.edit_lab', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
            'detail_pinjam_data',
    ...
    public function edit_kelas($id)
    {
        ...
        return view('peminjam.k3.menunggu.edit_kelas', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
            'detail_pinjam_data',
    ...
    public function edit_luar($id)
    {
        ...
        return view('peminjam.k3.menunggu.edit_luar', compact(
            'pinjam',
            'detail_pinjams',
            'detail_pinjam_data',
            'barangs'
