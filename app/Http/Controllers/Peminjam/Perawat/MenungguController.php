...
class MenungguController extends Controller
{
    public function index()
    {
        ...
        return view('peminjam.perawat.menunggu.index', compact('pinjams'));
    }
    ...
    public function show($id)
    {
        ...
        if (!$pinjam || $pinjam->status !== 'menunggu') {
            return redirect('peminjam/perawat')->with('error', 'Peminjaman tidak ditemukan!');
        }
    ...
    public function show_lab($id)
    {
        ...
        return view('peminjam.perawat.menunggu.show_lab', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
    ...
    public function show_kelas($id)
    {
        ...
        return view('peminjam.perawat.menunggu.show_kelas', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
            'pinjam_detail_bahans',
    ...
    public function show_luar($id)
    {
        ...
        return view('peminjam.perawat.menunggu.show_luar', compact(
            'pinjam',
            'detail_pinjams',
            'pinjam_detail_bahans',
        ));
    ...
    public function show_ruang($id)
    {
        ...
        return view('peminjam.perawat.menunggu.show_ruang', compact('pinjam', 'data_kelompok'));
    }
    ...
    public function edit_lab($id)
    {
        ...
        return view('peminjam.perawat.menunggu.edit_lab', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
            'barangs',
    ...
    public function edit_kelas($id)
    {
        ...
        return view('peminjam.perawat.menunggu.edit_kelas', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
            'barangs',
    ...
    public function edit_luar($id)
    {
        ...
        return view('peminjam.perawat.menunggu.edit_luar', compact(
            'pinjam',
            'detail_pinjams',
            'barangs',
        ));
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('peminjam/perawat/menunggu')->with('success', 'Berhasil memperbarui Peminjaman');
    }
