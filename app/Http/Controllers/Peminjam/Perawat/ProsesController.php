...
class ProsesController extends Controller
{
    ...
    public function edit_lab($id, $data = null)
    {
        ...
        return view('peminjam.perawat.proses.edit_lab', compact('pinjam', 'data_kelompok', 'detail_pinjams', 'barangs', 'data'));
    }
    ...
    public function edit_kelas($id, $data = null)
    {
        ...
        return view('peminjam.perawat.proses.edit_kelas', compact('pinjam', 'data_kelompok', 'detail_pinjams', 'barangs', 'data'));
    }
    ...
    public function edit_luar($id, $data = null)
    {
        ...
        return view('peminjam.perawat.proses.edit_luar', compact('pinjam', 'detail_pinjams', 'barangs', 'data'));
    }
