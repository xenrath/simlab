...
class RiwayatController extends Controller
{
    public function index()
    {
        ...
        return view('peminjam.ti.riwayat.index', compact('pinjams', 'total'));
    }
    ...
    public function show_lab($id)
    {
        ...
        return view('peminjam.ti.riwayat.show_lab', compact(
            'pinjam',
            'detail_pinjams',
        ));
    }
    ...
    public function show_kelas($id)
    {
        ...
        return view('peminjam.ti.riwayat.show_kelas', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
            'tagihan_peminjamans',
    ...
    public function show_luar($id)
    {
        ...
        return view('peminjam.ti.riwayat.show_luar', compact(
            'pinjam',
            'detail_pinjams'
        ));
    }
    ...
    public function show_ruang($id)
    {
        ...
        return view('peminjam.ti.riwayat.show_ruang', compact('pinjam', 'data_kelompok'));
    }
}
