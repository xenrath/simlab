...
class ProsesController extends Controller
{
    public function index()
    {
        ...
        return view('peminjam.ti.proses.index', compact('pinjams', 'total'));
    }
    ...
    public function show_lab($id)
    {
        ...
        return view('peminjam.ti.proses.show_lab', compact('pinjam', 'detail_pinjams'));
    }
    ...
    public function show_kelas($id)
    {
        ...
        return view('peminjam.ti.proses.show_kelas', compact('pinjam', 'data_kelompok', 'detail_pinjams'));
    }
    ...
    public function show_luar($id)
    {
        ...
        return view('peminjam.ti.proses.show_luar', compact('pinjam', 'detail_pinjams'));
    }
    ...
    public function show_ruang($id)
    {
        ...
        return view('peminjam.ti.proses.show_ruang', compact('pinjam', 'data_kelompok'));
    }
    ...
    public function edit_lab($id)
    {
        ...
        return view('peminjam.ti.proses.edit_lab', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
            'detail_pinjam_data',
    ...
    public function edit_kelas($id)
    {
        ...
        return view('peminjam.ti.proses.edit_kelas', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
            'detail_pinjam_data',
    ...
    public function edit_luar($id)
    {
        ...
        return view('peminjam.ti.proses.edit_luar', compact(
            'pinjam',
            'detail_pinjams',
            'detail_pinjam_data',
            'barangs'
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('peminjam/ti/proses');
    }
}
