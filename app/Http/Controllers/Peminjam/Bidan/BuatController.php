...
class BuatController extends Controller
{
    ...
    public function create()
    {
        ...
        switch ($praktik_id) {
            case '1':
                return redirect('peminjam/bidan/buat/praktik-laboratorium');
            case '2':
                return redirect('peminjam/bidan/buat/praktik-kelas');
            case '3':
                return redirect('peminjam/bidan/buat/praktik-luar');
            case '4':
                return redirect('peminjam/bidan/buat/praktik-ruang');
            default:
    ...
    public function create_praktik_laboratorium()
    {
        $cek = $this->cek();
        if (!$cek['status']) {
            return redirect('peminjam/bidan/buat')->with('error', $cek['message']);
        }
        ...
        return view('peminjam.bidan.buat.create_lab', compact('ruangs', 'peminjams', 'barangs'));
    }
    ...
    public function create_praktik_kelas()
    {
        ...
        return view('peminjam.bidan.buat.create_kelas', compact('laborans', 'barangs', 'peminjams'));
    }
    ...
    public function create_praktik_luar()
    {
        ...
        return view('peminjam.bidan.buat.create_luar', compact('laborans', 'barangs'));
    }
    ...
    public function create_praktik_ruang()
    {
        ...
        return view('peminjam.bidan.buat.create_ruang', compact('ruangs', 'peminjams'));
    }
    ...
    public function store_praktik_laboratorium(Request $request)
    {
        ...
        return redirect('peminjam/bidan/menunggu')->with('success', 'Berhasil membuat Peminjaman');
    }
