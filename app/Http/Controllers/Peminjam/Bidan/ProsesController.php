...
class ProsesController extends Controller
{
    public function index()
    {
        ...
        return view('peminjam.bidan.proses.index', compact('pinjams', 'total'));
    }
    ...
    public function show_lab($id)
    {
        ...
        return view('peminjam.bidan.proses.show_lab', compact('pinjam', 'data_kelompok', 'detail_pinjams'));
    }
    ...
    public function show_kelas($id)
    {
        ...
        return view('peminjam.bidan.proses.show_kelas', compact('pinjam', 'data_kelompok', 'detail_pinjams'));
    }
    ...
    public function show_luar($id)
    {
        ...
        return view('peminjam.bidan.proses.show_luar', compact('pinjam', 'detail_pinjams'));
    }
    ...
    public function edit_lab($id, $data = null)
    {
        ...
        return view('peminjam.bidan.proses.edit_lab', compact('pinjam', 'data_kelompok', 'detail_pinjams', 'barangs', 'data'));
    }
    ...
    public function edit_kelas($id, $data = null)
    {
        ...
        return view('peminjam.bidan.proses.edit_kelas', compact('pinjam', 'data_kelompok', 'detail_pinjams', 'barangs', 'data'));
    }
    ...
    public function edit_luar($id, $data = null)
    {
        ...
        return view('peminjam.bidan.proses.edit_luar', compact('pinjam', 'detail_pinjams', 'barangs', 'data'));
    }
    ...
    public function update_lab($request, $id)
    {
        ...
        return redirect('peminjam/bidan/proses');
    }
