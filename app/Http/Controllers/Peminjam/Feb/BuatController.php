...
class BuatController extends Controller
{
    ...
    {
        return view('peminjam.feb.buat.index');
    }
    ...
    public function create_lab()
    {
        ...
        return view('peminjam.feb.buat.create_lab', compact('ruangs', 'barangs', 'peminjams'));
    }
    ...
    public function create_luar()
    {
        ...
        return view('peminjam.feb.buat.create_luar', compact('barangs', 'peminjams'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($praktik_id == '1') {
            ...
            alert()->error('Gagal!', 'Kategori peminjaman tidak ditemukan!');
            return redirect('peminjam/feb/buat');
        }
    }
