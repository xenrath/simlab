...
class MenungguController extends Controller
{
    public function index()
    {
        ...
        return view('peminjam.feb.menunggu.index', compact('pinjams', 'total'));
    }
    ...
    public function show_lab($id)
    {
        ...
        return view('peminjam.feb.menunggu.show_lab', compact('pinjam', 'detail_pinjams'));
    }
    ...
    public function show_kelas($id)
    {
        ...
        return view('peminjam.feb.menunggu.show_kelas', compact('pinjam', 'data_kelompok', 'detail_pinjams'));
    }
    ...
    public function show_luar($id)
    {
        ...
        return view('peminjam.feb.menunggu.show_luar', compact('pinjam', 'detail_pinjams'));
    }
    ...
    public function show_ruang($id)
    {
        ...
        return view('peminjam.feb.menunggu.show_ruang', compact('pinjam', 'data_kelompok'));
    }
    ...
    public function edit_lab($id)
    {
        ...
        return view('peminjam.feb.menunggu.edit_lab', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
            'detail_pinjam_data',
    ...
    public function edit_kelas($id)
    {
        ...
        return view('peminjam.feb.menunggu.edit_kelas', compact(
            'pinjam',
            'data_kelompok',
            'detail_pinjams',
            'detail_pinjam_data',
    ...
    public function edit_luar($id)
    {
        ...
        return view('peminjam.feb.menunggu.edit_luar', compact(
            'pinjam',
            'detail_pinjams',
            'detail_pinjam_data',
            'barangs'
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('peminjam/feb/menunggu');
    }
