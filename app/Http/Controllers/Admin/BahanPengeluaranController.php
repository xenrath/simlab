...
class BahanPengeluaranController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.bahan-pengeluaran.create', compact('prodis', 'satuans'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.bahan-pengeluaran.edit', compact('bahan', 'prodis'));
    }
    ...
    {
        return view('admin.bahan-pengeluaran.scan');
    }
    ...
    public function cetak(Request $request, $id)
    {
        ...
        $pdf = Pdf::loadview('admin.bahan-pengeluaran.barcode-cetak', compact('bahan', 'jumlah', 'bahans'));
