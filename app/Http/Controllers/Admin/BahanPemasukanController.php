...
class BahanPemasukanController extends Controller
{
    ...
    {
        return view('admin.bahan-pemasukan.create_scan');
    }
    ...
    public function store_manual(Request $request)
    {
        ...
        return redirect('admin/bahan-pemasukan')->with('success', 'Berhasil membuat Pemasukan Bahan');
    }
    ...
    public function store_scan(Request $request)
    {
        ...
        return redirect('admin/bahan-pemasukan')
