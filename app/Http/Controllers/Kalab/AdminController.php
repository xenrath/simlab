...
class AdminController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('kalab.admin.index', compact('users'));
    }
    ...
    //     return view('kalab.admin.create', compact('prodis', 'ruangs'));
    // }
    ...
    public function show($id)
    {
        ...
        return view('kalab.admin.show', compact('user'));
    }
